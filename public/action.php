...
//  $mail->addAddress('flaming3012@gmail.com');
 $mail->addAddress('zvenposad@gmail.com');
...
<table style="width: 100%;">';
    ...
    if (!empty($_POST['text'])) {
        $html .= ' <tr style="background-color: #f8f8f8;"> <td style="padding: 10px; border: #e9e9e9 1px solid;"> Имя:</td>   <td style="padding: 10px; border: #e9e9e9 1px solid;">' . $_POST['text'] . '</b></td>';
    }
